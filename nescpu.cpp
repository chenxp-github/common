// NesCpu.cpp: implementation of the CNesCpu class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// Construction/Destruction of CNesR6502
//////////////////////////////////////////////////////////////////////
CNesR6502::CNesR6502()
{
    this->InitBasic();
...
//////////////////////////////////////////////////////////////////////
// Construction/Destruction of CNesCpu
//////////////////////////////////////////////////////////////////////
CNesCpu::CNesCpu()
{
    this->InitBasic();
...
int CNesCpu::InitBasic()
{
    this->mapper = NULL;
    this->DMA_cycles = 0;
    this->m_bClockProcess = 0;
    this->STACK = NULL;
    this->TOTAL_cycles = 0;
    this->ZN_Table = NULL;
    this->mmu = NULL;
...
int CNesCpu::Copy(CNesCpu *p)
{
    if(this == p)
        return OK;
    return OK;
}
int CNesCpu::Comp(CNesCpu *p)
{
    return 0;
}
int CNesCpu::Print()
...
int CNesCpu::DMA(int cycles)
{
    DMA_cycles += cycles;
    return OK;
}

int CNesCpu::EXEC(INT request_cycles)
{
    BYTE    opcode;
...
inline BYTE CNesCpu::OP6502(WORD addr)
{
    return  mmu->CPU_MEM_BANK[addr>>13][addr&0x1FFF];
}

inline WORD CNesCpu::OP6502W(WORD addr)
{
    BYTE b1 = this->OP6502(addr);
    BYTE b2 = this->OP6502(addr+1);
    
    WORD ret = (b2 << 8) | b1;
    return ret;
}

inline BYTE CNesCpu::RD6502(WORD addr)
{
    if( addr < 0x2000 ) {
...
inline WORD CNesCpu::RD6502W(WORD addr)
{
    if( addr < 0x2000 ) 
    {
        // RAM (Mirror $0800, $1000, $1800)
        BYTE b1 = mmu->RAM[addr&0x07FF];
        BYTE b2 = mmu->RAM[(addr+1)&0x07FF];
        WORD ret = (b2 << 8) | b1;
        return  ret;
    } 
    else if( addr < 0x8000 ) 
...
inline int CNesCpu::WR6502(WORD addr, BYTE data)
{
    if( addr < 0x2000 ) {
    // RAM (Mirror $0800, $1000, $1800)
...
int CNesCpu::GetContext(CNesR6502 *r)
{
    ASSERT(r);
    *r = this->R;
...
int CNesCpu::SetContext(CNesR6502 *r)
{
    ASSERT(r);
    this->R = *r;
...
int CNesCpu::ClrIRQ(BYTE mask)
{
    R.INT_pending &= ~mask;
    return OK;
}

int CNesCpu::SetIRQ(BYTE mask)
{
    R.INT_pending |= mask;
    return OK;
}
